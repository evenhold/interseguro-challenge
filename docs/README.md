...
Documentación sobre los objetivos y la arquitectura del proyecto.

- [Overview](challenge/overview.md) — Objetivos, criterios de evaluación y stack
- [Architecture](challenge/architecture.md) — Arquitectura de los 3 servicios

## Matemáticas

Conceptos matemáticos usados en el reto (rotación, vectores, QR).
...
1. [Overview](challenge/overview.md) — Entender el reto
